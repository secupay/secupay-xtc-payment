...
class secupay_ls_xtc
{
    ...
    public function selection()
    {
        ...
        if ($order->info['currency'] == 'EUR') {
            ...
            $logo = "<img alt=\"" . MODULE_PAYMENT_SPLS_TEXT_DESCRIPTION . "\" style=\"border:0;\" src=\"https://www.secupay.ag/sites/default/files/media/Icons/" . $lang_logo . "secupay_debit.png\" align=\"middle\" height=\"38px\"  />";
            $title = $logo;
