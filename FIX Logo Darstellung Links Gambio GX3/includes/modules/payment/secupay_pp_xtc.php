...
class secupay_pp_xtc
{
    ...
    public function selection()
    {
        ...
        if ($order->info['currency'] == 'EUR') {
            ...
            $logo = "<img alt=\"" . MODULE_PAYMENT_SPPP_TEXT_DESCRIPTION . "\" style=\"border:0;\" src=\"https://www.secupay.ag/sites/default/files/media/Icons/" . $lang_logo . "secupay_prepay.png\" align=\"middle\" height=\"38px\" />";
            $title = $logo;
