...
class secupay_sk_xtc
{
    ...
    public function selection()
    {
        ...
        if ($order->info['currency'] == 'EUR') {
            ...
            $logo = "<img alt=\"" . MODULE_PAYMENT_SPSK_TEXT_DESCRIPTION . "\" style=\"border:0;\" src=\"https://cdn.klarna.com/1.0/shared/image/generic/badge/" . $lang_logo . "pay_now/standard/pink.svg\" align=\"middle\" height=\"38px\" />";
            $title = $logo;
