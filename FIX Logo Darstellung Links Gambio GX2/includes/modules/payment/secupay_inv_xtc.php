...
class secupay_inv_xtc
{
    ...
    public function selection()
    {
        ...
        if ($order->info['currency'] == 'EUR') {
            ...
            $logo = "<img alt=\"" . MODULE_PAYMENT_SPINV_TEXT_DESCRIPTION . "\" style=\"border:0;margin: -9px -9px -18px -2px;\" src=\"https://www.secupay.ag/sites/default/files/media/Icons/" . $lang_logo . "secupay_invoice.png\" align=\"middle\" height=\"38px\" />";
            $title = $logo;
            ...
            $selection['description'] = "<br />" . MODULE_PAYMENT_SECUPAY_SPINV_TEXT_INFO;
    ...
    public function before_process()
    {
        ...
        if (!isset($_SESSION['sp_success'])) {
            ...
            $module_config->add_tax_for_shipping = MODULE_PAYMENT_SPINV_MWST;
