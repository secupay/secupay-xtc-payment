...
define('MODULE_PAYMENT_SECUPAY_B2B_XTC_STATUS_DESC', 'Möchten Sie Rechnungskäufe B2B über secupay abwickeln? (Rechnungskauf B2B & Rechnungkauf B2C unterschiedlichen Kundengruppen zuweisen! Ein gesonderter Vertrag ist nötig, wenden Sie sich bitte an Ihren Kundenberater.)');
define('MODULE_PAYMENT_SECUPAY_B2B_XTC_STATUS_TITLE', 'Rechnungskauf B2B');

define('MODULE_PAYMENT_SPB2B_ZONE_TITLE', 'Zahlungszone');
define('MODULE_PAYMENT_SPB2B_ZONE_DESC', 'Für welche Zone soll Rechnungskauf angezeigt werden?');

define('MODULE_PAYMENT_SECUPAY_B2B_APIKEY_TITLE', 'API.key');
define('MODULE_PAYMENT_SECUPAY_B2B_APIKEY_DESC', 'Ihr secupay API.key');

define('MODULE_PAYMENT_SPB2B_ORDER_STATUS_ID_TITLE', 'Bestellstatus nach Datenübermittlung');
...
define('MODULE_PAYMENT_SPB2B_ORDER_STATUS_ISSUE_ID_DESC', 'z. B. Rücklastschrift, Chargeback');
...
define('MODULE_PAYMENT_SPB2B_SIMULATION_MODE_DESC', 'Legen Sie hier den gewünschten Modus fest.');

define('MODULE_PAYMENT_SPB2B_LOGGING_TITLE', 'Debugmodus');
define('MODULE_PAYMENT_SPB2B_LOGGING_DESC', 'Bitte aktivieren Sie diese Funktion nur nach Rücksprache mit unserem Kundendienst.');

define('MODULE_PAYMENT_SPB2B_KAEUFERSCHUTZ_TITLE', 'Käuferschutz');
define('MODULE_PAYMENT_SPB2B_KAEUFERSCHUTZ_DESC', 'Soll der Käuferschutzhinweis während des Bestellprozesses angezeigt werden?');

define('MODULE_PAYMENT_SPB2B_GUARANTEE_TITLE', 'Zahlungsgarantie');
define('MODULE_PAYMENT_SPB2B_GUARANTEE_DESC', 'Möchten Sie die Zahlungsgarantie in Anspruch nehmen?');

define('MODULE_PAYMENT_SPB2B_PREAUTH_TITLE', 'Vorautorisierung');
define('MODULE_PAYMENT_SPB2B_PREAUTH_DESC', 'Möchten Sie Zahlungen vorerst nur reservieren?');

define('MODULE_PAYMENT_SPB2B_SHOPNAME_TITLE', 'Shopname');
define('MODULE_PAYMENT_SPB2B_SHOPNAME_DESC', 'Möchten Sie eine abweichende Shopbezeichnung im Verwendungszweck ausgeben?');

define('MODULE_PAYMENT_SPB2B_MWST_TITLE', 'Mehrwertsteuer auf Versandkosten');
define('MODULE_PAYMENT_SPB2B_MWST_DESC', 'Möchten Sie die MwSt auf Versandkosten extra berechnen? (evtl. notwendig bei Fehlern im Shopsystem)');

define('MODULE_PAYMENT_SPB2B_BID_TITLE', 'Bidirektionalität');
define('MODULE_PAYMENT_SPB2B_BID_DESC', 'Bidirektionale Kommunikation mit secupay aktivieren?');

define('MODULE_PAYMENT_SPB2B_CESSION_Q_TITLE', 'Abtretungserklärung');
define('MODULE_PAYMENT_SPB2B_CESSION_Q_DESC', 'In welcher Form wünschen Sie Ihre Kunden anzusprechen?');

define('MODULE_PAYMENT_SPB2B_WARNDELIVERY_TITLE', 'Warnhinweis bei abweichender Lieferanschrift');
define('MODULE_PAYMENT_SPB2B_WARNDELIVERY_DESC', 'Möchten Sie den Warnhinweis bei abweichender Lieferanschrift anzeigen lassen?');

define('MODULE_PAYMENT_SPB2B_CESSION_MODE_TITLE', 'Form der Abtretungserkläung');
define('MODULE_PAYMENT_SPB2B_CESSION_MODE_DESC', 'Möchten Sie die Abtretungserklärung perönlich oder geschäftlich darstellen?');

define('MODULE_PAYMENT_SECUPAY_SPB2B_TEXT_INFO', 'Sie überweisen den Rechnungsbetrag nach Erhalt und Prüfung der Ware.');
...
define('MODULE_PAYMENT_SPB2B_DELIVERY_HINT', "<p style='color:red;'>Der Versand erfolgt ausschließlich an die angegebene Rechnungsadresse.</p>");
define('MODULE_PAYMENT_SPB2B_DEMO_HINT', "\n\nAchtung, Transaktion im Demo-Modus durchgeführt!\n");

define('MODULE_PAYMENT_SPB2B_CONFIRMATION_URL', "Rechnungskauf als fällig markieren.");
define('MODULE_PAYMENT_SPB2B_SHOW_QRCODE_TITLE', 'QR-Code anzeigen');
define('MODULE_PAYMENT_SPB2B_SHOW_QRCODE_DESC', 'Möchten Sie den QR-Code auf der Rechnung anzeigen?');
define('MODULE_PAYMENT_SPB2B_QRCODE_DESC', 'Um diese Rechnung bequem online zu zahlen, können Sie die folgende Adresse aufrufen oder den QR-Code mit einem internetfähigen Gerät einscannen.');
define('MODULE_PAYMENT_SPB2B_QRCODE_PDF_DESC', 'Um diese Rechnung bequem online zu zahlen, können Sie die folgende Adresse aufrufen oder den QR-Code mit einem internetfähigen Gerät einscannen.');
define('MODULE_PAYMENT_SPB2B_QRCODE_PDF_HINT', ' - für weitere Informationen siehe letzte Seite');

define('MODULE_PAYMENT_SPB2B_KONTO_NR_TITLE', "Kontonummer");
define('MODULE_PAYMENT_SPB2B_KONTO_NR_DESC', "Kontonummer für Rechnungsdruck");
define('MODULE_PAYMENT_SPB2B_BLZ_TITLE', "BLZ");
define('MODULE_PAYMENT_SPB2B_BLZ_DESC', "BLZ für Rechnungsdruck");
define('MODULE_PAYMENT_SPB2B_BANKNAME_TITLE', "Bank");
define('MODULE_PAYMENT_SPB2B_BANKNAME_DESC', "Bankname für Rechnungsdruck");
define('MODULE_PAYMENT_SPB2B_IBAN_TITLE', "IBAN");
define('MODULE_PAYMENT_SPB2B_IBAN_DESC', "IBAN für Rechnungsdruck");
define('MODULE_PAYMENT_SPB2B_BIC_TITLE', "BIC");
define('MODULE_PAYMENT_SPB2B_BIC_DESC', "BIC für Rechnungsdruck");

define('MODULE_PAYMENT_SPB2B_INVOICE_TEXT', "Der Rechnungsbetrag wurde an die [recipient_legal] abgetreten. <br><b>Eine Zahlung mit schuldbefreiender Wirkung ist nur auf folgendes Konto möglich:</b><br><br>Empfänger: ");
define('MODULE_PAYMENT_SPB2B_INVOICE_TEXT_PDF', "Der Rechnungsbetrag wurde an die [recipient_legal] abgetreten. Eine Zahlung mit schuldbefreiender Wirkung ist nur auf folgendes Konto möglich:\n\nEmpfänger: ");
...
define('MODULE_PAYMENT_SPB2B_DELIVERY_DISABLE_DESC', 'Möchten Sie die Zahlungsart bei abweichender Lieferanschrift deaktivieren? Alternativ ist es möglich einen Hinweis anzuzeigen.');

define('MODULE_PAYMENT_SPB2B_DUE_DATE_TEXT', 'Fällig 10 Tage nach Lieferung.');
define('MODULE_PAYMENT_SPB2B_DUE_DATE_TEXT_PDF', 'Fällig 10 Tage nach Lieferung.');
define('MODULE_PAYMENT_SPB2B_DUE_DATE_TITLE', 'Zahlungsfrist anzeigen');
define('MODULE_PAYMENT_SPB2B_DUE_DATE_DESC', 'Möchten Sie die Zahlungsfrist auf der Rechnung anzeigen?');

define('MODULE_PAYMENT_SPB2B_PAYMENTINFO_TO_COMMENT_TITLE', 'Zahlungsinformationen zu Bestellkommentar hinzufügen.');
define('MODULE_PAYMENT_SPB2B_PAYMENTINFO_TO_COMMENT_DESC', 'Diese Option ist nicht mit allen Shopversionen kompatibel! Wählen Sie bitte die zu Ihrer Wawi passende Variante.');
...
define('MODULE_PAYMENT_SPB2B_SELECT_NAME_DESC', 'z. B. customer_b2b_status oder customer_vat_id für SteuerId.');
