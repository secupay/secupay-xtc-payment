...
class secupay_ls_xtc
{
    ...
    public function selection()
    {
        ...
        if ($order->info['currency'] == 'EUR') {
            ...
            $logourl = "https://www.secupay.ag/sites/default/files/media/Icons/".$lang_logo."secupay_debit.png";
            $logoalt = MODULE_PAYMENT_SPLS_TEXT_DESCRIPTION;
            $title = $this->title;

            $selection = [
                'id'          => $this->code,
                'module'      => $title,
                'description' => MODULE_PAYMENT_SECUPAY_SPLS_TEXT_INFO,
                'logo_url'    => $logourl,
                'logo_alt'    => $logoalt,
            ];
            return $selection;
