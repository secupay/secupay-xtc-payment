...
class secupay_kk_xtc
{
    ...
    public function selection()
    {
        ...
        if ($order->info['currency'] == 'EUR') {
            ...
            $logourl = "https://www.secupay.ag/sites/default/files/media/Icons/".$lang_logo."secupay_creditcard.png";
            $logoalt = MODULE_PAYMENT_SPKK_TEXT_DESCRIPTION;
            $title = $this->title;

            $selection = [
                'id'          => $this->code,
                'module'      => $title,
                'description' => MODULE_PAYMENT_SECUPAY_SPKK_TEXT_INFO,
                'logo_url'    => $logourl,
                'logo_alt'    => $logoalt,
            ];
