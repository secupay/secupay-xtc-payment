...
class secupay_sk_xtc
{
    ...
    public function selection()
    {
        ...
        if ($order->info['currency'] == 'EUR') {
            ...
            $logourl = "https://cdn.klarna.com/1.0/shared/image/generic/badge/" . $lang_logo . "pay_now/standard/pink.svg";
            $logoalt = MODULE_PAYMENT_SPSK_TEXT_DESCRIPTION;
            $title = $this->title;

            $selection = [
                'id'          => $this->code,
                'module'      => $title,
                'description' => MODULE_PAYMENT_SECUPAY_SPSK_TEXT_INFO,
                'logo_url'    => $logourl,
                'logo_alt'    => $logoalt,
            ];
